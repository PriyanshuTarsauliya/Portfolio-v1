          ...
          >
            {experience.certificates.map((cert, index) => (
              <img
                ...
                className="w-auto h-32 md:h-40 object-contain rounded-md border border-accent/20 hover:border-accent/60 hover:scale-105 transition-all duration-300 shadow-sm"
              />
            ))}
          </motion.div>
        )}
